...
function agregaretiva(quien){
	...
	if(retencion != '0' && baseaux!= '0' && baseaux!= '' && basereal > 0 && base > 0){
      ...
      var forFix = Math.round((newtotal * 100)/100).toFixed(2);

      document.getElementById('totaldebe1').value=(arreglar(forFix));
...
function RemoveRowIva(tb){
  ...
  document.getElementById('totaldebe').value=(Math.round(newtotal * 100)/100).toFixed(2);
  document.getElementById('totaldebe1').value=(Math.round(newtotal * 100)/100).toFixed(2);
...
function agregaret(cual){
	...
	if(pasaret==true){
        ...
        document.getElementById('totaldebe1').value=total;
			}
			if(cual==1){
